        ...
        <td>
          <div className="flex items-center justify-between gap-2">
            <Link href={`/list/students/${item.id}`}>
              <button className="w-7 h-7 flex  items-center justify-between rounded-full bg-blue-200 pl-1">
                <Image src="/view.png" alt="" width={20} height={20} />
              </button>
            </Link>
            {role === "admin" && (
              // <button className="w-7 h-7 flex  items-center justify-between rounded-full bg-purple-200 pl-1">
